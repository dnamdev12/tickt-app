...
const RenderMap = (props: any) => {
    ...
    const setMapCenter = () => {
        ...
        const newCenter = {
            lat: mapCenterCoordinates?.length > 0 ? mapCenterCoordinates[0]?.location?.coordinates[1] : -37.840935, //lat
            lng: mapCenterCoordinates?.length > 0 ? mapCenterCoordinates[0]?.location?.coordinates[0] : 144.946457 //lng
        }
