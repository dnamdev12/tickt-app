            ...
            <div class="custom_container">
                <div class="flex_headrow">
                    ...
                    <ul class="auth_btn">
                        ...
                        <li>
                            <a href="https://ticktreactstg.appskeeper.in/signup" class="fill_btn btn-effect"><!-- <a href="" class="fill_btn btn-effect" data-toggle="modal" data-target="#SignupModal"> -->Sign-up for free</a>
                        </li>
                        <li>
                            <a href="https://ticktreactstg.appskeeper.in/login" class="fill_grey_btn btn-effect"><!-- <a href="" class="fill_grey_btn btn-effect" data-toggle="modal" data-target="#OnboardModal"> -->Log In</a>
                        </li>
